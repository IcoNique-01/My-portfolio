...
const DashboardTable = ({ limit, head, btn }: DashboardTableProps) => {
    ...
    <div className="bg-white dark:bg-slate-800 rounded-2xl mt-5 shadow-sm overflow-x-hidden">
      ...
      <div className="overflow-x-auto">
        <table className="w-full text-left border-collapse ">
          <thead>
            <tr className="bg-gray-50 text-nowrap text-gray-500 dark:bg-gray-500 dark:text-gray-50 text-xs font-semibold uppercase border-b border-gray-200 ">
            ...
            {filterPost.length > 0 ? (
              filterPost.map((records) => (
                ...
                >
                  ...
                  <td className="px-3 py-6 text-nowrap text-gray-500 dark:text-gray-300 font-medium ">
                    {records.created_at}
                  </td>
                </tr>
              ))
