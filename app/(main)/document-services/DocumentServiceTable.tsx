...
const DashboardServiceTable = ({ limit, head, btn }: DashboardTableProps) => {
            ...
            {filterPost.length > 0 ? (
              filterPost
                ...
                .map((log, index) => (
                  ...
                  >
                    <td className="px-3 py-6 text-gray-900 dark:text-white font-semibold">
                      {log.id}
                    </td>
                    <td className="px-3 text-nowrap py-6 text-gray-900 dark:text-white ">
                      {log.customer_name}
                    </td>
